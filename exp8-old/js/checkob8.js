...
function checkmd(){
 ...
 /*if ( (0.35 == checkwd) && (0.5 == checkhd ) && ( 5.42 ==checkld )&& (checkrd ==0.25 )){
    ...
    document.getElementById("alertmsg").innerHTML="You cannot keep empty. Enter value between 0.34 and 0.36";
      ...
      document.getElementById("checkobsn").style.display = "block";
      document.getElementById("checkobsn").classList.add("show");
      document.getElementById("alertmsg").innerHTML="You cannot keep empty. Enter value between 0.4 and 0.6";
      ...
      document.getElementById("checkobsn").style.display = "block";
      document.getElementById("checkobsn").classList.add("show");
      document.getElementById("alertmsg").innerHTML="You cannot keep empty. Enter value between 5.41 and 5.5";
      ...
      document.getElementById("checkobsn").style.display = "block";
      document.getElementById("checkobsn").classList.add("show");
      document.getElementById("alertmsg").innerHTML="You cannot keep empty. Enter duct radius 0.25";
